...
console.log(sentence); // 出力: これは reduce の 例です
...
console.log(fruitCounts); // 出力: { apple: 3, banana: 2, orange: 2 }
...
console.log(object); // 出力: { key1: 'value1', key2: 'value2', key3: 'value3' }
...
console.log(expensiveProduct); // 出力: { id: 3, name: 'Monitor', price: 5000 }
...
console.log(transpose); // 出力: [[1, 4, 7], [2, 5, 8], [3, 6, 9]]
